 ...
 */
 ...
 (function(){
    ...
    *
    */
    loginRequiredInterceptor.$inject = ['$rootScope', '$compile', 'bootbox', '$templateRequest', 'LoadingModalService', 'authService', 'CommonFactory'];
    function loginRequiredInterceptor($rootScope, $compile, bootbox, $templateRequest, LoadingModalService, authService, CommonFactory) {
        var noRetryRequest;
        var dialog;
